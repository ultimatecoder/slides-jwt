...
### Points to remember!
  ...
  * If user is logged out, and token is removed then also the token will be
  accepted until it is expired by time.

  * Keep less values at claim.
...
Slides cab be found here https://ultimatecoder.github.io/slides-jwt/
